...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./public/images/dashboard.png" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Dashboard - Admin</b></h3>
...
>
> Dashboard - Admin is a responsive design of an admin panel that shows the various menus of an app on a side menu. It also has a top nav menu that also displays some menu items. The dashboard includes
...
> - Display Analytics with graph
> - Display side menu and top menu items
> - Manage Users
> - Manage Products
...
```sh
cd dashboard-admin
https://github.com/anyars-encarta/dashboard-admin.git
```
...
- [ ] **Add functionalities to the design**
...
- **What new features should be expected in the next release of the project?**
  ...
  - I am currently working on adding functionalities to the design.
